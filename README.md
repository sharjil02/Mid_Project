...
- 🛍 *Shopping Cart:* Add or remove items dynamically using JavaScript  
- 💰 *Dynamic Price Calculation:* Automatically updates total cost, delivery charge, and discount  
- 📱 *Responsive Design:* Works perfectly on desktop, tablet, and mobile devices  
- 🌙 *(Optional)* Dark mode toggle for better user experience  
...
1. Clone the repository:
   ```bash
   git clone https://github.com/adnan-jahangir/mid-project.git
